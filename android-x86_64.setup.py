...
class PyBuildExt(build_ext):
    ...
    def detect_modules(self):
        ...
        if cross_compiling:
            ...
            add_dir_to_list(
                ...
                "/opt/android/ndk/default/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/x86_64-linux-android/29/",
            )
            add_dir_to_list(
    ...
    def detect_ctypes(self, inc_dirs, lib_dirs):
        ...
        ext = Extension(
            ...
            extra_compile_args=extra_compile_args,
            extra_link_args=extra_link_args,
            libraries=["/android/x86_64/lib/libpython3.7m.so"],
            sources=sources,
            depends=depends,
        )
        ...
        inc_dirs.append("/android/x86_64/include")
        ffi_inc = ["/android/x86_64/include"]
        ...
        ffi_lib = None
        lib_dirs.append("/android/x86_64/lib")
        if ffi_inc is not None:
            for lib_name in ("ffi", "ffi_pic"):
                if self.compiler.find_library_file(lib_dirs, lib_name):
                    ffi_lib = lib_name
                    break
        ffi_lib = "/android/x86_64/lib/libffi.so"
        ffi_h = "/android/x86_64/include/ffi.h"
    ...
    def _detect_openssl(self, inc_dirs, lib_dirs):
        ...
        openssl_includes = ["/android/x86_64/include/"]
        openssl_libdirs = ["/android/x86_64/lib/"]
        if not openssl_libs:
